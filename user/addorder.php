<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        ...
        if (empty($username)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $insert_stmt = $db->prepare("INSERT INTO orderuser(username, itemsell, price) VALUES (:uname, :it, :pri)");
                   
                    $insert_stmt->bindParam(':uname', $username);
                    $insert_stmt->bindParam(':it', $itemsell);
                    $insert_stmt->bindParam(':pri', $price);
...
<body>
    ...
    <div class="container">
    <div class="display-3 text-center">Buy Item</div>
    ...
    <form method="post" class="form-horizontal mt-5">
            ...
            <div class="form-group">
            <div class="col-sm-12">
                <select name="txt_price" class="form-control">
