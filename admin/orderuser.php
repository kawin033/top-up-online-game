<?php 
    ...
    if (isset($_REQUEST['delete_order'])) {
        $username = $_REQUEST['delete_order'];

        $select_stmt = $db->prepare("SELECT * FROM orderuser WHERE username = :uname");
        $select_stmt->bindParam(':uname', $username);
        $select_stmt->execute();
        $row = $select_stmt->fetch(PDO::FETCH_ASSOC);

        // Delete an original record from db
        $delete_stmt = $db->prepare('DELETE FROM orderuser WHERE username = :uname');
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="page"href="orderuser.php">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Home</a></li>
                                   ...
                                   <h1 class="h2">Orders in</h1>
                                  <p>This is the homepage for manage users Oder</p>
                                     <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                       <div class="table-responsive">
                                                          <table class="table">
                                                             ...
                                                             <tbody>
                                                             <?php 
                                                                $select_stmt = $db->prepare("SELECT * FROM orderuser");
                                                                $select_stmt->execute();
                                                                while ($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td><a href="?delete_order=<?php echo $row["username"]; ?>" class="btn btn-danger">Delete</a></td>
                                                                  </tr>
